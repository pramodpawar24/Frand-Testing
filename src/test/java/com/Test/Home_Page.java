...
//		Library.costom_click(login.getLink(), "Hyper_Link");
	    ...
	    Library.costom_click(login.getTxt_patent(), "Patent");
	    
	     Library.costom_click(login.getTxt_Patent_search(), "Patent_search");
...
//		Thread.sleep(5000);
//	    login.getTemplate_button().click();
//	    Library.costom_click(login.getTxt_FRANDAVANUE_main_button(), "home_page");
...
//		act.moveToElement(login.getYour_patent_button()).click().build().perform();
...
//		act.moveToElement(login.getYour_Portfolio_Button()).click().build().perform();
		Library.costom_click(login.getTxt_FRANDAVANUE_main_button(), "home_page");
